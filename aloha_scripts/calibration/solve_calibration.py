...
if __name__ == "__main__":
    ...
    # Load data
    cam_id = 0
    data_dirname = os.path.join(dirpath, "new_data")
    data_dirname = "/home/lifanyu/frankapy/calibration/new_data/"
    data_filepath = os.path.join(data_dirname, "new_cam0_data.pkl")
    ...
    calib_dirname = os.path.join(dirpath, "new_calibration_results")
    os.makedirs(calib_dirname, exist_ok=True)
    filepath = os.path.join(calib_dirname, f"new_cam{cam_id}_calibration.npz")
